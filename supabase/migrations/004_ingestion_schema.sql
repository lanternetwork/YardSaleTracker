-- Ingestion schema for Craigslist scraping and data management
-- This migration creates the necessary tables for data ingestion
...
CREATE INDEX IF NOT EXISTS idx_geocode_cache_query ON public.geocode_cache (query_text);

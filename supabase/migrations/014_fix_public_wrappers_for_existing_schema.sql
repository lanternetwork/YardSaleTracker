-- Fix public wrappers to work with existing public schema
-- This migration creates public wrappers that work with the existing yard_sales table
...
-- Create public view for items_v2

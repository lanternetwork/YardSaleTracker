...
(
    'louisville-1', 'Louisville Community Yard Sale', 'Multi-family sale with furniture and electronics',
...
(
    'louisville-2', 'Louisville Estate Sale', 'Antiques and collectibles',
...
(
    'louisville-3', 'Louisville Moving Sale', 'Everything must go!',
...
(
    'nashville-1', 'Nashville Neighborhood Sale', 'Kids toys and clothing',
...
(
    'nashville-2', 'Nashville Vintage Sale', 'Retro clothing and records',
...
(
    'nashville-3', 'Nashville Garage Sale', 'Tools and home goods',
...
(
    'atlanta-1', 'Atlanta Community Sale', 'Furniture and electronics',
...
(
    'atlanta-2', 'Atlanta Estate Sale', 'Art and antiques',
...
(
    'atlanta-3', 'Atlanta Moving Sale', 'Household items',
...
(
    'atlanta-4', 'Atlanta Weekend Sale', 'Books and media',
...
-- Louisville items
('louisville-1', 'Vintage Chair', 'Comfortable armchair, good condition', 25.00),
('louisville-1', 'Coffee Table', 'Wooden coffee table with storage', 45.00),
('louisville-2', 'Antique Lamp', 'Brass table lamp, working', 35.00),
('louisville-2', 'Vintage Vase', 'Ceramic decorative vase', 15.00),
('louisville-3', 'Dining Table', '6-person dining table', 120.00),
('louisville-3', 'Bookshelf', '5-shelf wooden bookshelf', 60.00),

-- Nashville items
('nashville-1', 'Kids Bike', '12-inch bike, blue', 30.00),
('nashville-1', 'Toy Box', 'Wooden toy storage box', 25.00),
('nashville-2', 'Vintage Jacket', 'Leather jacket, size M', 40.00),
('nashville-2', 'Record Player', 'Working turntable', 80.00),
('nashville-3', 'Tool Set', 'Complete hand tool set', 50.00),
('nashville-3', 'Garden Tools', 'Shovels, rakes, and more', 35.00),

-- Atlanta items
('atlanta-1', 'Sofa', '3-seat sofa, beige', 150.00),
('atlanta-1', 'TV Stand', 'Wooden entertainment center', 75.00),
('atlanta-2', 'Painting', 'Original artwork, framed', 200.00),
('atlanta-2', 'Antique Clock', 'Mantle clock, working', 90.00),
('atlanta-3', 'Kitchen Set', 'Dishes, glasses, silverware', 40.00),
('atlanta-3', 'Bedding Set', 'Queen size comforter set', 30.00),
('atlanta-4', 'Book Collection', 'Mystery novels, 20 books', 25.00),
('atlanta-4', 'DVD Collection', 'Movies and TV shows', 15.00);
